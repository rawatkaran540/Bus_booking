    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                India's largest company for bus ticket booking, redBus, offers an easy-to-use online platform, thousands of bus operators to choose from, and plenty of offers on bus ticket booking to make road journeys super convenient for travelers. A leading platform for booking bus tickets, redBus has driven the country's bus
                </p>
            </div>
        </section>
        <section id="contact">
            <div id="contact-form">
                ...
                <form action="./admin/form.php" method="POST">
                    ...
                    <div><input type="submit" value="Submit" name="b1" id="b1"></div>
                </form>
            </div>
        </section>
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Bus Ticket Booking System | Made with &#10084;&#65039; by Ankit Raj
                        </p>
        </footer>
    </div>
